...
public class ListCategoriesAdapter extends RecyclerView.Adapter<ListCategoriesAdapter.MyViewHolder> {
    ...
    public ListCategoriesAdapter(Context context,ArrayList<String> moviesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.custom_list_categories, parent, false);
